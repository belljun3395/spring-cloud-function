...
class EventGridDemoApplicationTests {
	...
	@Test
	void testProcessEventFunction() {
		Function<CloudEvent, String> processEvent = functionCatalog.lookup("processEvent");
		assertThat(processEvent).isNotNull();
	...
	void testCreateEventFunction() {
		Function<Map<String, Object>, CloudEvent> createEvent = functionCatalog.lookup("createEvent");
